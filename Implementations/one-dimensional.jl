...
function plot_comparisson(ne, alpha, beta, gamma, f, u)
...
# Bound limits for analysing the error convergence
lb = 2
ub = 17

# Number of elements for plotting a comparisson graph and displaying the time it took to compute the approximation
ne = 1024

# Testing the implementation
plot_comparisson(ne, alpha, beta, gamma, f, u)
